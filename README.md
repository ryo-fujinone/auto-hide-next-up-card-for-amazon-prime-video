...
---
- 2026/03/25
  - プライムビデオの新UIでは現在多くの機能が正常に動作しません。必要であれば、Tampermonkey などで新旧UIを切り替えるユーザースクリプトを利用してください。
  - [https://gist.github.com/ryo-fujinone/ca42fd53d6d49256b21b6317eb385f25](https://gist.github.com/ryo-fujinone/ca42fd53d6d49256b21b6317eb385f25)
---
...
- X-Rayの非表示
- 各種テキストやボタンの非表示
  - （表示用のキーを押しながらマウスを操作している間は一時的に表示状態に）
  - タイトル
  - エピソード名
  - 右上の各種ボタン
  - シークバー
...
動画再生中に `Alt + P / Option + P` でオプションダイアログを開くことも可能です（ショートカットキーは変更可能）。  
